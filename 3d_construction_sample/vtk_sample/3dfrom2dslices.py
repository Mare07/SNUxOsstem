...
### Using VTK-7.0 (installed using conda)


DEBUG =False


# Change directory to your own folder of ct images.
directory="/home/tigerlily/Pictures/ct_coronal/"
...
# alphaChannelFunc.AddPoint(200, 0.0) # Black cube
alphaChannelFunc.AddPoint(0, 0.0) # Transparent margin
colorFunc.AddRGBPoint(0,0,0,0)

volumeProperty = vtk.vtkVolumeProperty()
volumeProperty.SetColor(colorFunc)
# volumeProperty.ShadeOn() # No shade
